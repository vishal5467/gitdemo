...
public class HtmlReportSupport {
	...
	public static void createHtmlSummaryReport(String browser,
		...
		try {
			...
			writer.write("<img align ='left' src= C:\\Users\\computer\\Desktop\\Hybrid_Training\\giggle_test\\Logos\\eyeglas.png></img>");
			writer.write("</th>");
			writer.write("<th class = 'Logos' colspan='2' > ");
			writer.write("<img align ='right' src= C:\\Users\\computer\\Desktop\\Hybrid_Training\\giggle_test\\Logos\\Cognizant.png></img>");
			writer.write("</th> ");
			writer.write("</tr> ");
